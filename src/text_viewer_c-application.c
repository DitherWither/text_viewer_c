...
G_DEFINE_TYPE (TextViewerCApplication, text_viewer_c_application, ADW_TYPE_APPLICATION)
...
text_viewer_c_application_activate (GApplication *app)
{
  ...
  if (window == NULL)
    window = g_object_new (TEXT_VIEWER_C_TYPE_WINDOW,
                           "application", app,
                           NULL);
...
text_viewer_c_application_about_action (GSimpleAction *action,
                                        ...
                                        gpointer       user_data)
{
  static const char *developers[] = {"Saumya Patil", NULL};
  ...
  adw_show_about_window (window,
                         "application-name", "text_viewer_c",
                         "application-icon", "com.example.TextViewerC",
                         "developer-name", "Saumya Patil",
                         "version", "0.1.0",
